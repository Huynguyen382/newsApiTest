    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-PUTapi-comments--id-">PUT api/comments/{id}</a>
                            </li>
                                ...
                                <a href="#endpoints-DELETEapi-comments--id-">DELETE api/comments/{id}</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-comments--id--approve">
                                <a href="#endpoints-PUTapi-comments--id--approve">PUT api/comments/{id}/approve</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-comments--id--reject">
                                <a href="#endpoints-PUTapi-comments--id--reject">PUT api/comments/{id}/reject</a>
                            </li>
...
<p>The <code>id</code> of an existing record in the users table. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-comments--id-">PUT api/comments/{id}</h2>
...
<p>The ID of the comment. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-comments--id--approve">PUT api/comments/{id}/approve</h2>
...
<form id="form-PUTapi-comments--id--approve" data-method="PUT"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PUTapi-comments--id--approve');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-comments--id--approve"
                    onclick="cancelTryOut('PUTapi-comments--id--approve');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>The ID of the comment. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-comments--id--reject">PUT api/comments/{id}/reject</h2>
...
<form id="form-PUTapi-comments--id--reject" data-method="PUT"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PUTapi-comments--id--reject');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-comments--id--reject"
                    onclick="cancelTryOut('PUTapi-comments--id--reject');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
